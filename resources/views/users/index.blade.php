            ...
            <div class="dropdown show-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="button-container">
                        <a href="https://www.creative-tim.com/product/now-ui-dashboard-laravel" target="_blank"
                            class="btn btn-primary btn-block btn-round">Download Now</a>
                        <a href="https://now-ui-dashboard-laravel.creative-tim.com/docs/getting-started/laravel-setup.html"
                            target="_blank" class="btn btn-default btn-block btn-round">
                            <i class="now-ui-icons files_single-copy-04"></i>
                            Documentation
                        </a>
                        <a href="https://www.creative-tim.com/product/now-ui-dashboard-pro-laravel?ref=nud-free-upgrade-live"
                            target="_blank" class="btn btn-primary btn-block btn-round"> <i
                                class="now-ui-icons arrows-1_cloud-download-93"></i> Upgrade to PRO</a>
                    </li>
                    ...
                    <li class="button-container text-center">
                        <button id="twitter" class="btn btn-round btn-info sharrre"><i class="fab fa-twitter"></i>
                            · 45</button>
                        <button id="facebook" class="btn btn-round btn-info sharrre"><i
                                class="fab fa-facebook-f"></i> · 50</button>
                        <br>
                        <br>
